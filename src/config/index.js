const config = {
  prod: {
    ...
    chains: {
      ...
      '10': {
        rpcUrls: ['https://mainnet.optimism.io','https://optimism-mainnet.public.blastapi.io','https://optimism.gateway.tenderly.co','https://op-pokt.nodies.app','https://optimism-rpc.publicnode.com'],
      },
    },
    "snarkParamsSet": {
