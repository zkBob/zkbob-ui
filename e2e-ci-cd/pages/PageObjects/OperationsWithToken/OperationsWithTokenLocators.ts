...
const input_amount_deposit = '//span[text()="Deposit"]//ancestor::div//input[@placeholder="0"]';
const input_amount_transfer = '//span[text()="Transfer"]//ancestor::div//input[@placeholder="0"]';
const input_amount_withdraw = '//span[text()="Withdraw"]//ancestor::div//input[@placeholder="0"]';
